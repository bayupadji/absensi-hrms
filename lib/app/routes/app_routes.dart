...
class AppRoutes {
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: onboarding, page: () => OnboardingPage(), binding: binding),
    GetPage(name: login, page: () => LoginScreen(), binding: binding),
    GetPage(name: home, page: () => HomeScreen(), binding: binding),
    GetPage(
        name: detailSchedule, page: () => DetailSchedule(), binding: binding),
  ];
}
